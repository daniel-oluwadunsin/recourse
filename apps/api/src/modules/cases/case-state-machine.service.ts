...
> = {
  ...
  CLASSIFYING: ["PROCEDURE_RESOLUTION", "NEEDS_HUMAN"],
  EVIDENCE_COLLECTION: ["CASE_ANALYSIS"],
  EXHAUSTED: [],
  INTAKE: ["CLASSIFYING"],
  // Only an explicit, reason-scoped product action may invoke this recovery
  // edge. NEEDS_HUMAN remains terminal for legal/professional boundaries.
  NEEDS_HUMAN: ["PROCEDURE_RESOLUTION", "CASE_ANALYSIS", "READY_TO_APPEAL"],
  PROCEDURE_RESOLUTION: ["EVIDENCE_COLLECTION", "NEEDS_HUMAN"],
  // User answers or newly supplied evidence may reopen analysis before drafting.
  READY_TO_APPEAL: ["CASE_ANALYSIS", "AWAITING_USER_APPROVAL"],
  REPLANNING: [
    "EVIDENCE_COLLECTION",
    "READY_TO_APPEAL",
